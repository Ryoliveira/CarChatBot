...
public class CarInfo {
	 ...
	 */
	@JsonCreator
	public CarInfo(@JsonProperty("make") String carMake, @JsonProperty("model") String carModel,
			@JsonProperty("price") String carPrice, @JsonProperty("leaseLength") String carLease) {
		make = carMake;
		model = carModel;
		price = carPrice;
	...
	public String toString() {
		return String.join("\t", make, model, price, leaseLength);
	}
